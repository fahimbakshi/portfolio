    ...
    <footer className="bg-base-200 text-base-content">
      <div className="max-w-screen-2xl mx-auto px-6 sm:px-10 lg:px-16 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-bold">Fahim Bakshi</h3>
            ...
            <div className="flex items-center gap-3 mt-2">
              <a
                href="https://github.com/fahimbakshi"
                target="_blank"
                rel="noreferrer"
                aria-label="GitHub"
              ...
              <a
                href="https://www.linkedin.com/in/fahim-bakshi-480aaa314/"
                target="_blank"
                rel="noreferrer"
                aria-label="LinkedIn"
                className="btn btn-ghost btn-circle"
            ...
            <ul className="space-y-3 text-sm text-base-content/80">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto: bakshifahim6@gmail.com" className="text-sm link link-hover">bakshifahim6@gmail.com</a>
                </div>
              </li>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+91 9404109917" className="text-sm link link-hover">+91 9404109917</a>
                </div>
              </li>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-base-content/70">
          <div>© {new Date().getFullYear()} Fahim Bakshi. All rights reserved.</div>
