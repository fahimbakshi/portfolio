        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <aside className="space-y-6">
            <div className="card bg-base-100 text-base-content shadow-lg rounded-2xl p-6 transform transition duration-500 hover:scale-[1.01]">
              ...
              <ul className="space-y-3 text-sm text-base-content/80">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-base-content/70">bakshifahim6@gmail.com</div>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-base-content/70">+91 9404109917 </div>
                  </div>
                </li>
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <a href="https://github.com/fahimbakshi" target="_blank" rel="noreferrer" className="btn btn-ghost btn-circle">
                    <FaGithub />
                  </a>
                  <a href="https://www.linkedin.com/in/fahim-bakshi-480aaa314/" target="_blank" rel="noreferrer" className="btn btn-ghost btn-circle">
                    <FaLinkedin />
                  </a>
                </div>
              </div>
            ...
            <div className="card bg-base-100 text-base-content shadow-lg rounded-2xl p-6">
              ...
              <div className="mt-4">
                <a
                  href="mailto:bakshifahim6@gmail.com"
