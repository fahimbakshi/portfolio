    ...
    >
        ...
        <aside className="space-y-6">
            ...
            <div className="mt-3 space-y-3 text-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-base-content/60">
                    <a href="mailto: bakshifahim6@gmail.com">
                  bakshifahim6@gmail.com
                  </a>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <Link
                    to="https://www.linkedin.com/in/fahim-bakshi-480aaa314/"
                    target="_blank"
                    className="text-xs text-primary inline-flex items-center gap-1"
                  >
                    linkedin.com/in/fahim-bakshi <FaExternalLinkAlt className="text-xs" />
                  </Link>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <Link
                    to="https://github.com/fahimbakshi"
                    target="_blank"
                    className="text-xs text-primary"
                  >
                    github.com/fahimbakshi
                  </Link>
                </div>
              </div>
            </div>
          ...
          <div className="card bg-base-100 shadow-md p-6">
            ...
            <ul className="text-sm text-base-content/70 space-y-2">
              <li><strong>Experience:</strong> 6 month Internship (Software Engineer)</li>
      ...
      <footer className="card bg-base-100 shadow-md p-6 text-center">
        ...
        <div className="mt-4 flex justify-center gap-3">
          <a href="mailto: bakshifahim6@gmail.com" className="btn btn-primary btn-sm">
            Email Me
          </a>
